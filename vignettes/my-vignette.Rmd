...
The user can specify the `position` of the logo as well as it's `size`. The user is able to move the logo horizontally by specifying `align`. Positive values will shift the logo rightward while negative values shift it leftward:
