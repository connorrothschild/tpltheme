...
#'
#' Note: Adobe Caslon Pro and Lato must be installed on your computer for \code{font_install} to work.
#'
#' Test to see if Adobe Caslon Pro and Lato are imported and registered with \code{font_test()}.
#'
#' @md
#' @export
